...
(defmethod fn-handler "references" [_ reftable & refcolumns]
  (str "REFERENCES " (sqlf/to-sql reftable) (util/comma-join-args refcolumns)))
...
;; 自已增加的format, caesarhu

(defmethod fn-handler "identity-always" [_ & args]
  (str "GENERATED ALWAYS AS IDENTITY" (util/comma-join-args args)))

(defmethod fn-handler "identity-default" [_ & args]
  (str "GENERATED BY DEFAULT AS IDENTITY" (util/comma-join-args args)))
